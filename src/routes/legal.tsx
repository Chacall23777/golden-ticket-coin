...
const tx: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    tokenomicsP: "Sem alocação escondida para a equipe, 3% de taxa na compra e venda. 3% vai direto para LP queimada, aumentando a liquidez do $legal",
  ...
  en: {
    ...
    tokenomicsH2: "Tokenomics",
    tokenomicsP: "No hidden team allocation, 3% buy and sell tax. 3% goes directly to burnt LP, increasing $LEGAL's liquidity",
