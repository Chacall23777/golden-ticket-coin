...
.legal-nav .nav-presale-link:hover { opacity: 1; }
`;
...
const tx: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    tokenomicsP: "Sem alocação escondida para a equipe, 3% de taxa na compra e venda. 1% vai direto para LP queimada, aumentando a liquidez do $legal",
  ...
  en: {
    ...
    tokenomicsH2: "Tokenomics",
    tokenomicsP: "No hidden team allocation, 3% buy and sell tax. 1% goes directly to burnt LP, increasing $LEGAL's liquidity",
    ...
    <div className="legal-root" ref={rootRef}>
        ...
        <div className="hero-grid">
          <div className="hero-text">
            ...
            <div className="hero-actions">
              <Link to="/" className="btn-primary">{t.heroBtnPrimary}</Link>
      ...
      <section id="community" className="community">
        ...
        <div className="social-row">
          ...
          <a className="social-pill" href="https://t.me/elonlegal" target="_blank" rel="noreferrer">Telegram</a>
          ...
          <a className="social-pill" href="https://solscan.io/token/XhHLJpJtEHJucpYpAti2JvNs6eYsjeuFjRj9wvvaLDL" target="_blank" rel="noreferrer">Solscan</a>
        </div>
      </section>
